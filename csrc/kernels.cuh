...
template<typename T, int BLOCK_SIZE, int NUM_PER_TH, int IS_SIGNED> __global__ void kQuantizeBlockwiseDynamic(T * __restrict__ const A, float *absmax, unsigned char *out, const int n);
template<typename T, int BLOCK_SIZE, int THREADS, int NUM_PER_TH, int IS_SIGNED> __global__ void kDequantizeBlockwiseDynamic(unsigned char * __restrict__ const A, float * __restrict__ const absmax, T *out, const int n);
